...
// Hemisphere Light
const hemisphereLight = new THREE.HemisphereLight(0x0000ff, 0x00fff00, 0.9)
...
// RectArea Light
const rectAreaLight = new THREE.RectAreaLight(0x4e00ff, 8, 1, 1) // Only works with MeshStandardMaterial and MeshPhysicalMaterial
...
// Spot Light
const spotLight = new THREE.SpotLight(0x78ff00, 5, 10, Math.PI * 0.05, 0.8, 1)
...
const tick = () =>
{
    ...
    pointLight.position.x = Math.sin(elapsedTime * 2) * 2
    pointLight.position.z = Math.cos(elapsedTime * 2) * 1

    spotLight.target.position.x = Math.sin(elapsedTime * 1)
