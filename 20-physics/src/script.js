...
let oldElapsedTime = 0; // Used to calculate delta time

const tick = () => {
  const elapsedTime = clock.getElapsedTime(); // Time since the beginning of the application
  const deltaTime = elapsedTime - oldElapsedTime; // Time between each frame
